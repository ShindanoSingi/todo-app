                ...
                <main className='main'>
                    ...
                    <div className='todos-container'>
                        <div className='todo-card' style={{ backgroundColor: color }}>
                            ...
                            <img className='check-circle-icon' src={BsCheckCircleFill} alt='check-circle' />
                        </div>
                        <div className='todo-card' style={{ backgroundColor: color }}>
                            <p className='task-title'>gdfgdfgdfgdfgdfgdfgdfgdfgfdgdfgfgfdgdfgfdgdfgfdgdfgfgfdgdfgfdgdfgfdgd</p>
